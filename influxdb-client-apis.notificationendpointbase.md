...
|  --- | --- | --- |
|  [createdAt?](./influxdb-client-apis.notificationendpointbase.createdat.md) | string | <i>(Optional)</i> |
...
|  [links?](./influxdb-client-apis.notificationendpointbase.links.md) | { self?: [Link](./influxdb-client-apis.link.md)<!-- -->; labels?: [Link](./influxdb-client-apis.link.md)<!-- -->; members?: [Link](./influxdb-client-apis.link.md)<!-- -->; owners?: [Link](./influxdb-client-apis.link.md)<!-- -->; } | <i>(Optional)</i> |
...
|  [updatedAt?](./influxdb-client-apis.notificationendpointbase.updatedat.md) | string | <i>(Optional)</i> |
