...
|  [getSources(request, requestOptions)](./influxdb-client-apis.sourcesapi.getsources.md) |  | List all sources. See [https://v2.docs.influxdata.com/v2.0/api/\#operation/GetSources](https://v2.docs.influxdata.com/v2.0/api/#operation/GetSources) |
|  [getSourcesID(request, requestOptions)](./influxdb-client-apis.sourcesapi.getsourcesid.md) |  | Retrieve a source. See [https://v2.docs.influxdata.com/v2.0/api/\#operation/GetSourcesID](https://v2.docs.influxdata.com/v2.0/api/#operation/GetSourcesID) |
