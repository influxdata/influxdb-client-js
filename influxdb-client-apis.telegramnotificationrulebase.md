...
|  --- | --- | --- |
|  [disableWebPagePreview](./influxdb-client-apis.telegramnotificationrulebase.disablewebpagepreview.md) | boolean | Disables preview of web links in the sent messages when "true". Defaults to "false" . |
...
|  [parseMode](./influxdb-client-apis.telegramnotificationrulebase.parsemode.md) | 'MarkdownV2' \| 'HTML' \| 'Markdown' | Parse mode of the message text per https://core.telegram.org/bots/api\#formatting-options . Defaults to "MarkdownV2" . |
