...
var addDefaults = function (bucket) { return (__assign({}, bucket, { labels: (bucket.labels || []).map(labels_1.addLabelDefaults) })); };
...
var default_1 = (function () {
    ...
    default_1.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.service.bucketsBucketIDGet(id)];
                    case 1:
                        data = (_a.sent()).data;
    ...
    default_1.prototype.getAll = function (orgID) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.service.bucketsGet(undefined, undefined, undefined, undefined, orgID)];
                    case 1:
    ...
    default_1.prototype.create = function (bucket) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.service.bucketsPost(bucket)];
                    case 1:
                        data = (_a.sent()).data;
                        return [2, addDefaults(data)];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        original = _a.sent();
                        return [4, this.service.bucketsBucketIDPatch(id, __assign({}, original, bucket))];
                    case 2:
                        data = (_a.sent()).data;
                        return [2, addDefaults(data)];
                }
    ...
    default_1.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.service.bucketsBucketIDDelete(id)];
                    case 1:
                        data = (_a.sent()).data;
                        return [2, data];
                }
