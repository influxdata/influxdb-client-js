...
|  --- | --- | --- |
|  [useCancellable](./influxdb-client.fluxresultobserver.usecancellable.md) | (cancellable: [Cancellable](./influxdb-client.cancellable.md)<!-- -->) =&gt; void | Setups cancellable that can abort flux result processing. |
